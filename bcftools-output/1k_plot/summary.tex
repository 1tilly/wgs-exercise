...
ALL.c & 1,060,388 & 2.39 & 2.40 & 43,230 & -- & -- & 0 & 801 \\ 
%
...
ALL.c & 42.6\% & 2.28 & 0.2\% & 0.000 &  6,348 &4,063 \\ 
\end{tabular}
\vspace{2em}
\begin{itemize}[-]
\setlength{\itemsep}{0pt}
\item ALL.c .. \texttt{\footnotesize data/gz/ALL.chr22.phase3\_shapeit2\_mvncall\_integrated\_v5a.20130502.genotypes.vcf.\\\hskip2em gz}
